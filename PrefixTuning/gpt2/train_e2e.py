...
if __name__ == '__main__':
    ...
    parser.add_argument('--init_xavier', type=str, default='no', help='')
    parser.add_argument('--init_kaiming', type=str, default='no', help='')
    ...
    parser.add_argument('--finetuned_model_path', type=str,
                        default='/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/full/full/webnlgfinetune_n_20_act_ca'
    ...
    # Added by MX
    parser.add_argument('--cache_dir', type=str, default='/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/control', help='cache dir')
    ...
    if args.mode == 'data2text':
        ...
        TRAIN_FILE = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/DART/dart/data/v1.1.1/dart-v1.1.1-full-train.json"
        TEST_FILE = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/DART/dart/data/v1.1.1/dart-v1.1.1-full-dev.json"
        folder_name = "triples_models/"


    elif args.mode == 'webnlg':
        # 2017 Challeng Version.
        TRAIN_FILE = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/WebNLG/webnlg-dataset/webnlg_challenge_2017/train.json"
        TEST_FILE = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/WebNLG/webnlg-dataset/webnlg_challenge_2017/dev.json"

        # v2
        # TRAIN_FILE = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/WebNLG/webnlg-dataset/release_v2/json/webnlg_release_v2_train.json"
        # TEST_FILE =  "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/WebNLG/webnlg-dataset/release_v2/json/webnlg_release_v2_dev.json"
        ...
        TRAIN_FILE = '/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/seq2seq/cnn_dm/train.source'
        TEST_FILE = '/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/seq2seq/cnn_dm/val.source'
        ...
        TRAIN_FILE = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/seq2seq/xsum/train.source"
        TEST_FILE = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/seq2seq/xsum/val.source"
    ...
    if args.dir_name is None:
        Model_FILE = args.mode + args.tuning_mode + '_' + args.optim_prefix[:1] + '_' + str(args.preseqlen) + \
                     ...
                     '_x={}'.format(args.init_xavier[:1]) + '_k={}'.format(args.init_kaiming[:1]) + \
    ...
    app = "--optim_prefix {} --preseqlen {} --prefix_mode {} --format_mode {} " \
          ...
          "--mid_dim {} --init_random {}  --init_xavier {} --init_kaiming {} --use_dropout {} --prefix_dropout {} --objective_mode {} ".\
        format(args.optim_prefix, args.preseqlen, args.prefix_mode, args.format_mode,
               ...
               args.mid_dim, args.init_random, args.init_xavier, args.init_kaiming, args.use_dropout, args.dropout, args.objective_mode)
    ...
    if load_prefix_model:
        LOAD_TRAIN_PREFIX = '/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/control/med_topic_gen'
