...
def main():
    ...
    parser.add_argument("--gen_dir", type=str, default="save_e2e_models_convcheck")
    ...
    if args.task_mode == 'data2text':
        ...
        if QUICK_CHECK:
            ...
            if ('lowdata' in args.model_name_or_path) or (args.prefixModel_name_or_path is not None and 'lowdata' in args.prefixModel_name_or_path):
                test_path = '/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/data/e2e_data/src1_valid.txt'
            else:

                if args.eval_dataset == 'valid':
                    test_path = '/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/data/e2e_data/src1_valid.txt'
                elif args.eval_dataset == 'test':
                    test_path = '/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/data/e2e_data/src1_test.txt'
            ...
            decode_mode = 'beam'
            curr_dir = os.path.join('/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/gpt2/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file, decode_mode))
            print(curr_dir)
            gold_dir = os.path.join('/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/gpt2/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file,'gold'))
            print(gold_dir)
            write_e2e_corr(prompt_text_lst, prompt_text_dict, gold_dir)
            src_dir = os.path.join('/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/gpt2/',
                                   args.gen_dir,
        ...
        if args.task_mode == 'webnlg':
            if args.eval_dataset == 'valid':
                test_path = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/WebNLG/webnlg-dataset/webnlg_challenge_2017/dev.json"
            elif args.eval_dataset == 'test':
                test_path = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/WebNLG/webnlg-dataset/webnlg_challenge_2017/test.json"
            else:
            ...
            test_path = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/DART/dart/data/v1.1.1/dart-v1.1.1-full-test.json"
            # test_path = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/DART/dart/data/v1.1.1/dart-v1.1.1-full-dev.json"
        ...
        if QUICK_CHECK:
            ...
            decode_mode = 'beam'
            curr_dir = os.path.join('/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/text-generation/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file, decode_mode))
            print(curr_dir)
            gold_dir = os.path.join('/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/text-generation/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file, 'gold'))
            print(gold_dir)
            write_e2e_corr(prompt_text_pair, prompt_text_dict, gold_dir)
            src_dir = os.path.join('/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/text-generation/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file, 'src'))
        ...
        if args.task_mode == 'classify-sentiment':
            test_path = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/IMDB/test.txt"
            prompt_text_dict = read_classifySentiment_files(test_path, tokenizer)
        elif args.task_mode == 'classify-topic':
            test_path = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/text-classification/glue_data/AG-news/dev1.tsv"
        ...
        if QUICK_CHECK:
            ...
            curr_dir = os.path.join('/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/text-generation/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file, decode_mode))
            # curr_dir = '/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/text-generation/classify_results/{}_{}_{}'.format(
            #     temp, split_file, decode_mode)
            print(curr_dir)
            gold_dir = os.path.join('/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/text-generation/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file, 'gold'))
            # gold_dir = '/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/text-generation/classify_results/{}_{}_{}'.format(
            #     temp,
            #     split_file,
            #     'gold')
            print(gold_dir)
            ...
            src_dir = os.path.join('/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/text-generation/',
                                   args.gen_dir,
                                   '{}_{}_{}'.format(temp, split_file, 'src'))
            # src_dir = '/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/text-generation/classify_results/{}_{}_{}'.format(
            #     temp,
            #     split_file,
            #     'src')
            write_e2e_src(prompt_text_lst, src_dir)
        ...
        if args.task_mode == 'cnndm':
            test_path = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/seq2seq/cnn_dm/test.source"
            max_source_length = 512
            max_target_length = 142
            prompt_text_dict = read_sum_files(test_path, tokenizer, max_source_length, max_target_length)
        elif args.task_mode == 'xsum':
            test_path = "/content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/seq2seq/xsum/test.source"
            max_source_length = 512
    ...
    if args.task_mode == 'data2text':
        ...
        with open('commands.txt', 'w') as f:
            f.write("python /content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/e2e-metrics/measure_scores.py "
                  "{} {} -p  -t -H >> {}".format(gold_dir, curr_dir, out_file_eval))
        os.system("python /content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/e2e-metrics/measure_scores.py "
                  "{} {} -p  -t -H >> {}".format(gold_dir, curr_dir, out_file_eval))
        ...
        os.system("bash /content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/DART/dart/evaluation/run_eval_on_webnlg.sh "
        ...
        print(curr_dir)
        print(gold_dir)
        temp_command = "python /content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/classify-eval/eval.py {} {}".format(gold_dir, curr_dir)
        print(temp_command)
    ...
    if args.task_mode == 'topic' or args.task_mode == 'sentiment':
        ...
        temp_command = "python /content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/attribute-eval/eval.py {} ".format(curr_dir)
        print(temp_command)
        os.system(temp_command)
