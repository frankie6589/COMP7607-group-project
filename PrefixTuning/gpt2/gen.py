...
if __name__ == '__main__':
    ...
    if MODEL_FILE == 'gpt2-large':
        COMMANDLINE += ' --cache_dir /content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/control/gpt2-large-s3 '

    if MODEL_FILE == 'gpt2-medium':
        COMMANDLINE += ' --cache_dir /content/drive/MyDrive/Colab_Notebooks/PrefixTuning-cleaned/contrast_LM/transformers/examples/control/gpt2-medium-s3 '
